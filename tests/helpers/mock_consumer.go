...
// MustGetMockDVORulesConsumerWithExpectedMessages creates mocked DVO rules
// // consumer which produces list of messages automatically
// // calls t.Fatal on error
func MustGetMockDVORulesConsumerWithExpectedMessages(
	t testing.TB,
	topic string,
	orgAllowlist mapset.Set,
	messages []string,
...
// GetMockDVORulesConsumerWithExpectedMessages creates mocked DVO rules
// consumer which produces list of messages automatically
func GetMockDVORulesConsumerWithExpectedMessages(
	t testing.TB, topic string, orgAllowlist mapset.Set, messages []string,
) (*MockKafkaConsumer, func(), error) {
	mockStorage, storageCloser := MustGetMockStorage(t, true)
